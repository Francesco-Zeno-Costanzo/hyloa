...
def correct_hysteresis_loop(app_instance):
    '''
    Opens a hysteresis loop correction window in the main application.
    ...
    left_layout.addWidget(QLabel("---- Fit for coercivity exitamtion ----"))
    ...
    def clear_fit_lines():
        ''' Helper: clear previous fit lines from axes (gid startswith "fit")
        '''
    ...
    def refresh_preview():
        ...
        try:
            ...
            logger.exception("Error refreshing preview: %s", e)
    ...
    run_button.clicked.connect(perform_correction)
